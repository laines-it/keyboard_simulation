...
class Button:
    def __init__(self, button_text, keysizex, keysizey, surface, radiuss=0):
    ...
    def create_text(self):
        ...
        font_size = 30
        color_text = 'black'
        self.keytext = TextObject(textx, texty, lambda: self.button_text, color_text, font, font_size)
